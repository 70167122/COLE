...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo RUTA ?>public/js/dataTables.bootstrap.css">
     ...
     <!-- Navigation -->
      <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;border-bottom: 0;position:fixed;width: 100%;">
          ...
          <ul class="nav navbar-nav navbar-right" >
	        	...
	        	<li><a href="<?php echo RUTA  ?>admin/mensaje" aria-expanded="false"><i class="fa fa-envelope" style="color: #EEC21E ;font-size: 24px;"></i><span class="badge" style="left: 27px;width: 20px;" ><?php echo $cantidad_mensaje[0] ?></span></a></li>
              
            <li class="dropdown">

              <a  class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i  class="fa fa-bell" style="color: #EEC21E;font-size: 24px;"></i><span class="badge" style="width: 20px"><?php echo $_SESSION['perfil_id'] ?></span></a>
  			    ...
  			    <li class="dropdown">
  	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown" ><img src="<?php echo RUTA ?>public/images/DIRECTOR.png"><span class="user-info"><small><?php echo $_SESSION['nombre']." ".$_SESSION['apellido'] ?></small></span></a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="submenu" id="Reportes" >
                            ...
                            <ul class="nav nav-second-level submenu">
                                ...
                                <li>
                                    <a href="<?php echo RUTA  ?>admin/porcategorias">Por Categorias</a>
                                </li>
                        ...
                        <li class="submenu" id="Seguridad" >
                            <a href="#" class="link" onclick="click_submenu(this)"><i class="fa fa-lock nav_icon" aria-hidden="true"></i>Seguridad<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level submenu">
                                  <li id="usuarios">
