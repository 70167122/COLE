<?php 
	...
	$consulta = $conexion -> prepare("SELECT usuarios.id,personales.nombre,usuarios.usuario,usuarios.password,usuarios.recordar_password,usuarios.personal_id FROM usuarios INNER JOIN personales on usuarios.personal_id=personales.id WHERE usuarios.usuario LIKE '%$don%' OR usuarios.password LIKE '%$don%' OR personales.nombre LIKE '%$don%' ");
	$consulta -> execute();

	$resultado = $consulta -> fetchAll();

	$query = $conexion -> prepare("SELECT * FROM personales");
	$query -> execute();
	$personal = $query -> fetchAll();
