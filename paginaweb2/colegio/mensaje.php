     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;border-bottom: 0">
            ...
            <ul class="nav navbar-nav navbar-right">
	        		...
	        		<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-envelope" style="color: #EEC21E ;font-size: 24px;"></i><span class="badge" style="left: 27px;width: 20px;" ><?php echo $cantidad_mensajes[0] ?></span></a></li>
              ...
              <a href="#"  class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i  class="fa fa-bell" style="color: #EEC21E;font-size: 24px;"></i><span class="badge" style="width: 20px">10</span></a>
			    ...
			    <li class="dropdown">
                  ...
                  <small>Segundo Isaias 
                         Tananta Tenazoa</small>
                                </span></a>
	        		<ul class="dropdown-menu">
      ...
      <!--  <div class="cuadros-tres">
         <div class="col-md-4">
           <div class="cuadros">
             <h3>Visión</h3>
             <div class="contenido">
               <p>Ser la primera elección de las familias que garantice la formación, la madurez  emocional en valores necesarios para el futuro de nuestros estudiantes.</p>
             </div>
           </div>
         </div>
         <div class="col-md-4">
           <div class="cuadros">
             <h3>Misión</h3>
             <div class="contenido">
               <p>Asumimos de dar una educación de calidad a nuestros alumnos y la responsabilidad de dar una buena formación integral.</p>
             </div>
           </div>
