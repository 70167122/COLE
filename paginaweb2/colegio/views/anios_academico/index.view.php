<div id="page-wrapper" style="border-left: 0; min-height: 700px;padding: 82px 0px 10px 0px"> 
  ...
  <div class="row">
      ...
      <form id="form-buscar" action="<?php echo RUTA ?>admin/anios_academico/index.php" method="post">
    ...
    <div id="Modal-registrar" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Registrar Año Académico</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/anios_academico/guardar.php" method="post">
              ...
              <div class="form-group">
                <label >Lectivo</label>
                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="lectivo" ng-model="model.name"  onkeypress="return soloNumeros(event)">
              </div>
                 <div class="form-group">
                <label >Fecha Inicial</label>
                <input type="date" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="fecha_inicio" ng-model="model.name">
              </div>
               <div class="form-group">
                <label >Fecha Final</label>
                <input type="date" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="fecha_final" ng-model="model.name">
              </div>
