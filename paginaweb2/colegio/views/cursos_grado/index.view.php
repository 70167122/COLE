...
<div id="page-wrapper" style="border-left: 0; min-height: 700px;padding: 82px 0px 10px 0px"> 
  ...
  <div class="row">
      ...
      <form id="form-buscar" action="<?php echo RUTA ?>admin/cursos_grado/index.php" method="post">
    ...
    <div id="Modal-registrar" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Registrar Curso Según Grado</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/cursos_grado/guardar.php" method="post">

            
                 <div class="form-group ">
               <label>Curso</label>
               <select class="form-control1 ng-invalid ng-invalid-required" ng-model="model.select" name="Curso" required=""><option></option>
               <?php foreach ($cursos as $key => $values): ?>
              ...
              <?php endforeach; ?>
               ...
               <div class="form-group ">
               <label>Grado</label>
               <select class="form-control1 ng-invalid ng-invalid-required" ng-model="model.select" name="Grado" required=""><option></option>
               <?php foreach ($grados as $key => $values): ?>
               <option value="<?php echo $values['id'] ?>"><?php echo $values['descripciong'] ?>
