...
<div id="page-wrapper" style="border-left: 0; min-height: 700px;padding: 82px 0px 10px 0px"> 
  ...
  <div class="row">
      ...
      <form id="form-buscar" action="<?php echo RUTA ?>admin/vigencias/index.php" method="post">
 ...
 <table class="table table-bordered table-striped" id="example">  
    ...
    <tbody>
       <?php foreach ($vigencia as $key => $value):?>
      <tr>
                ...
                <div class="modal-content">
                  ...
                  <form  id="<?php echo 'form-editar'.$value['id'] ?>" action="<?php echo RUTA ?>admin/vigencias/editar.php" method="post">
                   ...
                   <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
                            ...
                            <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Fecha_Entrada" ng-model="model.name" value="<?php echo $value['fecha_entrada'] ?>">
                          </div>

                          <div class="form-group">
                            <label >Fecha Salida</label>
                            <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Fecha_Salida" ng-model="model.name" value="<?php echo $value['fecha_salida'] ?>">
                          </div>
