<div id="page-wrapper" style="border-left: 0; min-height: 700px;padding: 82px 0px 10px 0px"> 
  ...
  <div class="row">
      ...
      <form id="form-buscar" action="<?php echo RUTA ?>admin/personales/index.php" method="post">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group ">
                              ...
                              <select class="form-control1 ng-invalid ng-invalid-required" ng-model="model.select" name="Categoria" required="">
                                       ...
                                       <?php foreach ($categoria as $key => $valuess): ?>
                                      <?php if ($valuess['id']==$value['categoria_id']){   ?>
                                          <option selected value="<?php echo $values['id'] ?>"><?php echo $valuess['descripcion'] ?></option>
                                      <?php }else { ?>
                                          <option value="<?php echo $valuess['id'] ?>"><?php echo $valuess['descripcion'] ?></option>
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/personales/guardar.php" method="post">
             ...
             <div class="form-group">
               ...
               <div class="form-group">
                <label >Correo Electronico</label>
                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Correo" ng-model="model.name">
              </div>
              ...
              <?php endforeach; ?>
                ...
                <div class="form-group">
                <label >Tiempo Servicio</label>
                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Tiempo" ng-model="model.name">
              </div>

              <div class="form-group">
                <label >Nivel</label>
                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Nivel" ng-model="model.name">
              </div>
               ...
               <?php foreach ($categoria as $key => $valuess): ?>
               <option value="<?php echo $valuess['id'] ?>"><?php echo $valuess['descripcion'] ?>
