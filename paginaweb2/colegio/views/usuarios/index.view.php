...
<div id="page-wrapper" style="border-left: 0; min-height: 700px;padding: 82px 0px 10px 0px"> 
  ...
  <div class="row">
      ...
      <form id="form-buscar" action="<?php echo RUTA ?>admin/usuarios/index.php" method="post">
            ...
            <div class="modal fade modal-editar" id="editar-<?php echo $value['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form id="<?php echo 'form-editar'.$value['id'] ?>"  action="<?php echo RUTA ?>admin/usuarios/editar.php" method="post">
                   ...
                   <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
                          ...
                          <div class="form-group">
                            <label >Usuario</label>
                            <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Usuario" ng-model="model.name" value="<?php echo $value['usuario'] ?>">
                          </div>

                          <div class="form-group">
                            <label >Password</label>
                            <input type="password" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Password" ng-model="model.name" value="<?php echo $value['password'] ?>">
                          </div>

                         <!--  <div class="form-group">
                                  <label >Fecha Registro</label>
                                  <input type="date" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Fechas" ng-model="model.name" value="<?php echo $value['fecha_registro'] ?>">
                                </div>     -->       
            ...
            <div class="modal fade modal-eliminar" id="eliminar-<?php echo $value['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form id="<?php echo 'form-eliminar'.$value['id'] ?>"" action="<?php echo RUTA ?>admin/usuarios/eliminar.php" method="post">
                     <div class="modal-body">
                        <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
    ...
    <div id="Modal-registrar" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/usuarios/guardar.php" method="post">
              ...
              <div class="form-group">
                <label >Usuario</label>
                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Usuario" ng-model="model.name" onkeypress="return soloLetras(event)">
              </div>

              <div class="form-group">
                <label >Password</label>
                <input type="password" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Password" ng-model="model.name">
              </div>
         ...
         <!--     <div class="form-group">
            <label >Fecha Registro</label>
            <input type="date" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Fechas" ng-model="model.name" onkeypress="return soloLetras(event)">
          </div> -->
