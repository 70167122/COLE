                   ...
                   <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <input type="password" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="RPassword" ng-model="model.name" value="<?php echo $value['recordar_password'] ?>">
                          </div>
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/usuarios/guardar.php" method="post">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label >Recordar Password</label>
                <input type="password" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="RPassword" ng-model="model.name">
              </div>
...
<script src="<?php echo RUTA ?>public/js/dataTables.bootstrap.js"></script> 
...
<script>
    ...
    <script>
      $("#bus").keyup(function(){
        ler = $("#bus").val();
        dato = {palabra : ler};
        ruta = "<?php echo RUTA ?>ajax/buscar.php";
        $.ajax({
          data : dato,
          url : ruta,
          type : 'post',
