          ...
          <table class="table table-bordered table-striped" id="example">  
            ...
            <tr>
              ...
              <?php foreach ($aulas as $key => $a){ ?> 
                <tr>    
                  <td rowspan="<?php echo count($turnos);?>" >Aula <?php echo $key + 1;?></td>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Carga Academica</h5>
                  ...
                  <div class="modal-body">
                        ...
                        <input id="docente" placeholder="Buscar Docente">
                    
                    <!-- <div class="form-group">
                      <label for="exampleFormControlSelect1" class="col-md-12" style="text-align: left;">Nivel de Estudio: </label>
                    ...
                    <!-- <div class="form-group">
                      <label for="exampleFormControlSelect1" class="col-md-12" style="text-align: left;">Grado: </label>
                      <select class="form-control" id="grados">
                      </select>
                    </div> -->

                    <!-- <div class="form-group">
                      <label for="exampleFormControlSelect1" class="col-md-12" style="text-align: left;">Sección: </label>
                    ...
                    <!-- <div class="form-group">
                      <label for="exampleFormControlSelect1" class="col-md-12" style="text-align: left;">Aula: </label>
                      <select class="form-control" id="exampleFormControlSelect1">
                        <option value="">Seleccione Aula</option>
                        <?php foreach ($aulas as $key => $value): ?>
                        <option value="<?php echo $value['id'] ?>"><?php echo $value['descripcionc'] ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div> -->

                    <!-- <div class="form-group">
                      <label for="exampleFormControlSelect1" class="col-md-12" style="text-align: left;">Turno: </label>
                      <select class="form-control" id="exampleFormControlSelect1">
