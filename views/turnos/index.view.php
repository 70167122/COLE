            ...
            <div class="modal fade modal-editar" id="editar-<?php echo $value['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form id="<?php echo 'form-editar'.$value['id'] ?>"  action="<?php echo RUTA ?>admin/turnos/editar.php" method="post">
                   ...
                   <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
                           <div class="form-group">
                            ...
                            <input  type="time" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Hora_entrada" ng-model="model.name" value="<?php echo $value['hora_entrada'] ?>">
                          </div>

                            <div class="form-group">
                            <label >Hora Salida</label>
                            <input  type="time" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Hora_salida" ng-model="model.name" value="<?php echo $value['hora_salida'] ?>">
                          </div>
            ...
            <div class="modal fade modal-eliminar" id="eliminar-<?php echo $value['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form id="<?php echo 'form-eliminar'.$value['id'] ?>"" action="<?php echo RUTA ?>admin/turnos/eliminar.php" method="post">
                     <div class="modal-body">
                        <input type="hidden" name="id" value="<?php echo $value['id'] ?>">
                           ¿Desea eliminar Turno?
   ...
   <div id="Modal-registrar" class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="form-nuevo" action="<?php echo RUTA ?>admin/turnos/guardar.php" method="post">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label >Hora Entrada</label>
                <input type="time" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Hora_entrada" ng-model="model.name" >
              </div>


               <div class="form-group">
                <label >Hora Salida</label>
                <input type="time" class="form-control1 ng-invalid ng-invalid-required ng-touched" name="Hora_salida" ng-model="model.name" >
              </div>
    ...
    $('.aceptar_edicion').on( "click", function() {
     ...
     <script>
      $("#bus").keyup(function(){
        ler = $("#bus").val();
        dato = {palabra : ler};
        ruta = "<?php echo RUTA ?>ajax/buscart.php";
        $.ajax({
          data : dato,
          url : ruta,
          type : 'post',
